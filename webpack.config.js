...
module.exports = [
  {
    ...
    plugins: [
      ...
      new CustomPlugin("afterEmit", "MakeDocPlugin", (stats) => {
        const lpe = require('./dist/lpe.nodoc.js');
        const contextes = [lpe.STDLIB];
        DOC = lpe.makeDocForContextes(contextes);

        DOC_WARNINGS = lpe.DOC_WARNINGS;
