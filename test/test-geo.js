...
describe('LPE GEO', function() {
    it('should eval geo filters', function() {
...
WHERE (fot_out.hcode_name BETWEEN '2019-01-01' AND '2020-03-01') AND ((1 = pointInEllipses(0,0,0,0,1,1)) OR (pointInPolygon(tuple(lat,lng), [tuple(0,0),tuple(0,1),tuple(1,0),tuple(1,1)]) = 1))
